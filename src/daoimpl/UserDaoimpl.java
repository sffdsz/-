...
public class UserDaoimpl implements UserDao {
    ...
    private static  final String URL ="jdbc:MySQL://localhost:3307/shopingol?&useSSL=false&serverTimezone=UTC";
    static {
        try {
    ...
    public User getBuyerid(int userid) throws SQLException {
        User u=null;
    ...
    public List<String> getBuyer(String googid) throws SQLException{
