...
public class UserDaoimpl implements UserDao {
    ...
    private static  final String URL ="jdbc:mysql://localhost:3306/shoppingol?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC";
    static {
        try {
