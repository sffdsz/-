...
public class SellerDaoImpl implements SellerDao {
    public static String url="jdbc:mysql://localhost:3306/shoppingol?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC";
